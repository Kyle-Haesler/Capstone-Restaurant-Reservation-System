...
function Dashboard({ date }) {
  ...
  const [endDiningExperienceError, setEndDiningExperienceError] =
    useState(null);
      ...
      <div className="row">
        <div className="col-md-6">
          <ReservationsList
            ...
            cancelReservationError={cancelReservationError}
            filterFinishedCancelled={true}
          />
        </div>
        ...
        <div className="col-md-6">
          {tables.map((table) => (
            <div key={table.table_id}>
              ...
              <p>
                <strong>Reservation ID:</strong> {table.reservation_id}
              </p>
              <p>
